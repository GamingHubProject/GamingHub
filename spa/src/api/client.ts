...
export const api = {
  ...
  /** For a genuine whole-resource replace — the navigation tree, where a
   *  reorder rewrites every sibling and a partial update would mean the
   *  client computing a diff. */
